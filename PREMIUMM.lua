...
local senhasValidas = {
    ...
    ["ALDO"] = {usuario = "LIFETIME", dispositivos = "1", criado = "30/06/2026 H19:00", ano = 2028, mes = 7, dia = 20, hora = 10, min = 00},
    ...
    ["UCAY9"] = {usuario = "PREMIUM", dispositivos = "2", criado = "30/06/2026 H19:00", ano = 2026, mes = 7, dia = 25, hora = 08, min = 05},
    ["BELBEL"] = {usuario = "PREMIUM", dispositivos = "2", criado = "30/06/2026 H19:00", ano = 2026, mes = 7, dia = 30, hora = 19, min = 54},
    ["DIKA"] = {usuario = "PREMIUM", dispositivos = "2", criado = "30/06/2026 H19:00", ano = 2026, mes = 7, dia = 26, hora = 10, min = 25},
    ["SKYY"] = {usuario = "PREMIUM", dispositivos = "2", criado = "30/06/2026 H19:00", ano = 2026, mes = 7, dia = 28, hora = 14, min = 05},
    ...
    ["OKE80"] = {usuario = "PREMIUM", dispositivos = "1", criado = "12/07/2026 H15:19", ano = 2026, mes = 7, dia = 30, hora = 00, min = 25},
    ["MARSEL"] = {usuario = "LIFETIME", dispositivos = "1", criado = "30/06/2026 H19:00", ano = 2028, mes = 7, dia = 20, hora = 10, min = 00},
    ["SKUTSS"] = {usuario = "LIFETIME", dispositivos = "1", criado = "11/07/2026 H18:34", ano = 2028, mes = 7, dia = 12, hora = 18, min = 50},
    ["DIMAS523"] = {usuario = "LIFETIME", dispositivos = "1", criado = "11/07/2026 H18:34", ano = 2028, mes = 7, dia = 12, hora = 18, min = 50},
    ["NICOL"] = {usuario = "PREMIUM", dispositivos = "1", criado = "11/07/2026 H18:30", ano = 2026, mes = 7, dia = 18, hora = 18, min = 50},
    ["JAZAUL1507"] = {usuario = "PREMIUM", dispositivos = "1", criado = "01/01/2026 H08:00", ano = 2026, mes = 7, dia = 24, hora = 20, min = 25},
    ...
    ["RONZ"] = {usuario = "PREMIUM", dispositivos = "1", criado = "01/01/2026 H00:00", ano = 2026, mes = 7, dia = 22, hora = 12, min = 00},
    ...
    ["CASPER63"] = {usuario = "PREMIUM", dispositivos = "0", criado = "01/01/2026 H00:00", ano = 2026, mes = 7, dia = 28, hora = 16, min = 31},
    ["HAPIS"] = {usuario = "PREMIUM", dispositivos = "1", criado = "01/01/2026 H00:00", ano = 2026, mes = 7, dia = 28, hora = 15, min = 20},
